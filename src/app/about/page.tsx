...
export const metadata: Metadata = {
  title: "Giới thiệu",
  description: `Về ${site.name}: đang học gì, đã làm gì và cách liên hệ.`,
    ...
    <div className={`${containerClass} py-16 sm:py-20`}>
      ...
      <header className="grid gap-10 border-b-2 border-fg pb-12 lg:grid-cols-[1.4fr_1fr]">
        <div>
          ...
          <h1 className="mt-3 text-5xl leading-tight font-semibold tracking-tight text-fg sm:text-6xl">{site.name}</h1>
        ...
        <aside className="self-start border-2 border-fg bg-surface p-6">
          <p className="flex items-center gap-2 font-mono text-sm text-fg">
            ...
            {site.availability.open ? "Open to work" : "Not available"}
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            {site.cvUrl && (
              <a href={site.cvUrl} className={buttonSecondary} download>
